...
recurrence), and rejects any non-exact frontier-parseable match rather than
a low-confidence passthrough (D40's rationale: once text parses cleanly
into a step's exact grammar, a value mismatch is unambiguous).
"""
