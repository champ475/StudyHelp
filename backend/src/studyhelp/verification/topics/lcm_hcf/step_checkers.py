"""Per-step-type typed field models and field-level comparison for LCM/HCF
(NCERT Ch.6, "Be My Multiple, I'll Be Your Factor") — mirrors
...
class FindCommonValuesFields(BaseModel):
    values: list[int]
...
STEP_TYPE_FIELD_MODELS: dict[str, type[BaseModel]] = {
    "find_common_values": FindCommonValuesFields,
